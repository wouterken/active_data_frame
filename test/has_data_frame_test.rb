...
class HasDataFrameTest < TransactionalTest
  ...
  def test_it_uses_plain_sql_for_good_cross_compatibility
    assert_equal Airport.include_temperature('2001-01-01' => :t1).to_sql,
                "SELECT \"airports\".* FROM (SELECT * FROM airports  LEFT JOIN(SELECT temperature_blocks.data_frame_type, temperature_blocks.data_frame_id, temperature_blocks.t12 as \"t1\" FROM temperature_blocks  WHERE temperature_blocks.period_index = 11322) btemperature_blocks11322 ON btemperature_blocks11322.data_frame_type = 'Airport' AND btemperature_blocks11322.data_frame_id = airports.id) as airports"

    assert_equal Airport.include_temperature('2001-01-01' => "custom_name", '3001-01-01' => "custom_name_2").to_sql,
                "SELECT \"airports\".* FROM (SELECT * FROM airports  LEFT JOIN(SELECT temperature_blocks.data_frame_type, temperature_blocks.data_frame_id, temperature_blocks.t12 as \"custom_name\" FROM temperature_blocks  WHERE temperature_blocks.period_index = 11322) btemperature_blocks11322 ON btemperature_blocks11322.data_frame_type = 'Airport' AND btemperature_blocks11322.data_frame_id = airports.id LEFT JOIN(SELECT temperature_blocks.data_frame_type, temperature_blocks.data_frame_id, temperature_blocks.t12 as \"custom_name_2\" FROM temperature_blocks  WHERE temperature_blocks.period_index = 376564) btemperature_blocks376564 ON btemperature_blocks376564.data_frame_type = 'Airport' AND btemperature_blocks376564.data_frame_id = airports.id) as airports"

    assert_equal Airport.include_temperature('2001-01-01' => "temperature").include_departures('2001-01-01' => "departures").to_sql,
                "SELECT \"airports\".* FROM (SELECT * FROM airports  LEFT JOIN(SELECT temperature_blocks.data_frame_type, temperature_blocks.data_frame_id, temperature_blocks.t12 as \"temperature\" FROM temperature_blocks  WHERE temperature_blocks.period_index = 11322) btemperature_blocks11322 ON btemperature_blocks11322.data_frame_type = 'Airport' AND btemperature_blocks11322.data_frame_id = airports.id LEFT JOIN(SELECT departure_blocks.data_frame_type, departure_blocks.data_frame_id, departure_blocks.t12 as \"departures\" FROM departure_blocks  WHERE departure_blocks.period_index = 11322) bdeparture_blocks11322 ON bdeparture_blocks11322.data_frame_type = 'Airport' AND bdeparture_blocks11322.data_frame_id = airports.id) as airports"
  end
end